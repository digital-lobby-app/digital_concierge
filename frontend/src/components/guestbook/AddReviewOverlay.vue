...
const emit = defineEmits<{
  (e: 'close'): void;
  (e: 'submit', payload: { name: string; review: string }): void;
}>();
...
//submit form
const submitReview = () => {
// TODO: submit review.. need to create service for it
}
</script>
        ...
        <div ref="contentRef" class="content">
          ...
          <form class="form" @submit.prevent="submitReview">
            ...
            <label class="field field-grow">
              ...
              <textarea v-model="review" placeholder="Tell us about your stay..." />
            </label>
